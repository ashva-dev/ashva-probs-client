...
import com.pzone.ashva.probs.client.model.AsProbs;
import com.pzone.ashva.probs.client.model.LiveProbs;
    ...
    try {
      ...
      socketClient.addMessageHandler(new MessageHandler() {
        ...
        public void handleMessage(String message) {
          final LiveProbs clientProbs= gson.fromJson(message, LiveProbs.class);
          LOG.info("Live Probs {}", gson.toJson(clientProbs));
        }
      });
